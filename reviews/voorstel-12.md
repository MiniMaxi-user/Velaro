...
startpagina en denkt: "Dit heb ik al gelezen" — terwijl het nieuw is. Hij mist
...
paard. De mededelingenfunctie is nu functioneel maar passief — de eigenaar
...
- prisma/schema.prisma — StableNoteRead model plus relaties op StableNote en User
- src/features/mededelingen/queries.ts — getUnreadCountForOwner toevoegen
- src/features/mededelingen/actions.ts — markNotesAsRead toevoegen
- src/app/(app)/eigenaar/page.tsx — ongelezen-teller ophalen en badge renderen
- src/app/(app)/paarden/[id]/page.tsx — markNotesAsRead aanroepen voor eigenaren
