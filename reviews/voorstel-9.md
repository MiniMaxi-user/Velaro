...
Nu is de mededelingenfunctie — de primaire communicatielijn richting de
paardeneigenaar — aan de beurt.

---

## Waarom waardevol voor de doelgroep (pensionstallen)

Mededelingen zijn de officiële communicatie tussen stal en eigenaar binnen
...
- Bouwvolgorde stap 5 in CLAUDE.md: "Eigenaarscommunicatie + gedeeld profiel"
  — de mededelingenfunctie is gebouwd (stap 5), maar pas volledig als ook de
...
Scope: één nieuwe server action, uitbreiding van MededelingenSectie met
...
— dat zou de integriteit van de communicatiehistorie aantasten.

### 2. MededelingenSectie uitbreiden met inline bewerkstaat

Bestand: src/features/mededelingen/MededelingenSectie.tsx

Voeg toe bovenaan de component (useState import bestaat al niet — voeg toe):
...
- src/features/mededelingen/actions.ts — nieuwe updateNote action toevoegen
- src/features/mededelingen/MededelingenSectie.tsx — inline bewerkstaat
